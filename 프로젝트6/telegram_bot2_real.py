...
def DB_info_total(corp,db_type,date,info_list, id = 5322933876):
    ...
    if db_type == '영업이익':
        val_text = f'{corp}의 2021년  {db_type}는 {val}배 입니다'
    
    elif db_type == 'PER':
        val_text = f'{corp}의 {date} {db_type}는 {val}배 입니다'
...
def handler(update, context): 
    ...
    if corp == '종목명 없음':
        ...
        if user_text in reco_lst1:
            reco_text3_5 = text_invest_result(3,0.05,'2022-03-30')
            reco_text3_10 = text_invest_result(3,0.1,'2022-03-30')
            reco_text3_15 = text_invest_result(3,0.15,'2022-03-30')
            reco_text6_5 = text_invest_result(6,0.05,'2022-03-30')
            reco_text6_10 = text_invest_result(6,0.1,'2022-03-30')
            reco_text6_15 = text_invest_result(6,0.15,'2022-03-30')
            bot.send_message(chat_id=id, text=reco_text3_5)
